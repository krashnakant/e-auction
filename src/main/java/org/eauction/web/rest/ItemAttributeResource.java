...
public class ItemAttributeResource {
    ...
    public ItemAttributeResource(ItemAttributeRepository itemAttributeRepository, ItemAttributeMapper itemAttributeMapper) {
     ...
     *
     * @param itemAttributeDTO the itemAttributeDTO to create
     * @return the ResponseEntity with status 201 (Created) and with body the new itemAttributeDTO, or with status 400 (Bad Request) if the itemAttribute has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/item-attributes")
    @Timed
    public ResponseEntity<ItemAttributeDTO> createItemAttribute(@Valid @RequestBody ItemAttributeDTO itemAttributeDTO) throws URISyntaxException {
        log.debug("REST request to save ItemAttribute : {}", itemAttributeDTO);
        if (itemAttributeDTO.getId() != null) {
            throw new BadRequestAlertException("A new itemAttribute cannot already have an ID", ENTITY_NAME, "idexists");
        }
     ...
     *
     * @param itemAttributeDTO the itemAttributeDTO to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated itemAttributeDTO,
     * or with status 400 (Bad Request) if the itemAttributeDTO is not valid,
     * or with status 500 (Internal Server Error) if the itemAttributeDTO couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/item-attributes")
    @Timed
    public ResponseEntity<ItemAttributeDTO> updateItemAttribute(@Valid @RequestBody ItemAttributeDTO itemAttributeDTO) throws URISyntaxException {
     ...
     *
     * @return the ResponseEntity with status 200 (OK) and the list of itemAttributes in body
     */
     ...
     *
     * @param id the id of the itemAttributeDTO to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the itemAttributeDTO, or with status 404 (Not Found)
     */
     ...
     *
     * @param id the id of the itemAttributeDTO to delete
