...
import { AppMetricsMonitoringModalComponent } from './metrics-modal.component';
...
export class AppMetricsMonitoringComponent implements OnInit {
    ...
    refreshThreadDumpData() {
        this.metricsService.threadDump().subscribe((data) => {
            const modalRef  = this.modalService.open(AppMetricsMonitoringModalComponent, { size: 'lg'});
