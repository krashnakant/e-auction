...
public class CategoryResourceIntTest {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCategoryImageContentType()).isEqualTo(DEFAULT_CATEGORY_IMAGE_CONTENT_TYPE);
    }
    ...
    @Test
    @Transactional
    public void checkCategoryImageIsRequired() throws Exception {
        int databaseSizeBeforeTest = categoryRepository.findAll().size();
        // set the field null
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getCategoryImageContentType()).isEqualTo(UPDATED_CATEGORY_IMAGE_CONTENT_TYPE);
    }
